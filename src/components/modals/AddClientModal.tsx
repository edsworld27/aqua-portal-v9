    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
      ...
      >
        <div className="flex items-center justify-between mb-6 md:mb-8">
          <div>
            <h3 className="text-xl md:text-2xl font-semibold">Setup New Client</h3>
            <p className="text-xs md:text-sm text-slate-500">Configure the workspace and initial access for your new partner.</p>
          </div>
          <button 
            onClick={onClose}

...
export const inboxViewUI = {
  ...
  sidebar: {
    ...
    newChannel: {
      ...
      userBtn: {
        ...
        fontSize: 'text-xs',
        radius: 'rounded',
        activeStyle: 'bg-indigo-600/20 text-indigo-400',
        inactiveStyle: 'hover:bg-white/5',
        iconSize: 'w-3 h-3',
      },
      createBtn: 'w-full p-2 bg-indigo-600 rounded text-sm font-medium mb-4',
  ...
  main: {
    ...
    input: {
      ...
      sendBtn: 'px-4 py-2 bg-indigo-600 rounded text-sm font-medium',
      sendLabel: 'Send',

...
export const designDashboardUI = {
  ...
  concepts: {
    ...
    card: {
      ...
      btnPrimary: 'px-2 md:px-3 py-1 md:py-1.5 bg-indigo-600 text-white text-[8px] md:text-[9px] lg:text-[10px] font-bold rounded-lg uppercase tracking-widest',
      ...
      statusBadge: 'absolute top-2 right-2 md:top-3 md:right-3 lg:top-4 lg:right-4 px-1.5 md:px-2 py-0.5 md:py-1 bg-black/60 backdrop-blur-md rounded-lg text-[8px] md:text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-indigo-400 border border-indigo-400/30',
    },
    items: [
  ...
  feedback: {
    ...
    msgAgency: {
      ...
      avatarFlex: 'flex-shrink-0 flex items-center justify-center font-bold',
      avatarTextColor: 'text-indigo-400',
      avatarFontSize: 'text-xs md:text-sm',
      avatarInitials: 'AA',
      nameSize: 'text-xs md:text-sm',
      nameFontWeight: 'font-medium',
    ...
    input: {
      ...
      field: 'flex-1 bg-white/5 border border-white/10 rounded-xl px-3 md:px-4 py-2 md:py-2.5 lg:py-3 text-xs md:text-sm outline-none focus:border-indigo-500/50 transition-colors',
      placeholder: 'Add a comment...',
      sendBtn: 'p-2 md:p-2.5 lg:p-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl transition-colors shrink-0',
  ...
  assets: {
    ...
    row: {
      ...
      iconColor: 'text-slate-500 group-hover:text-indigo-400 transition-colors shrink-0',
      ...
      downloadColor: 'text-slate-600 group-hover:text-indigo-400 transition-colors shrink-0',
    },

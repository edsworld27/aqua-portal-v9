...
export const onboardingViewUI = {
  ...
  questionnaire: {
    ...
    question: {
      ...
      textarea: 'w-full bg-white/5 border border-white/10 rounded-xl md:rounded-2xl p-3 md:p-4 text-xs md:text-sm outline-none focus:border-indigo-500/50 transition-colors min-h-[80px] md:min-h-[100px]',
  ...
  upload: {
    ...
    dropZone: {
      ...
      group: 'group',
      iconWrapper: 'w-12 h-12 md:w-16 md:h-16 bg-indigo-500/10 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform',
